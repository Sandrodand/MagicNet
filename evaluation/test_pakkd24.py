...
PATH_PERFORMANCE = "acpnn_qcpnn"  # path to write the outputs of the evaluation
...
batch_learners = batch_learners_acpnn_qcpnn
...
try:
    for path in PATHS:
        ...
        print("BATCH LEARNERS:", [(m.name, m.drift_supervised) for m in batch_learners])
        print("SUFFIX:", suffix)
        print()
