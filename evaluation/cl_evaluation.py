        ...
        for model_dict in self.learners_config:
            ...
            for task_train, model_task in enumerate(
                ...
                for task_test in range(len(self.X)):
                    ...
                    for idx, (x, y) in enumerate(zip(self.X[task_test], self.Y[task_test])):
                        if count % 5 == 0:
                            print(
                        ...
                        self.predictions[model_name][iteration][task_train][task_test].append(y_hat)
                        ...
                        if update_inference:
                            ...
                            if y_update is not None:
                                model_task.update_inference(y_update, timestamp=idx-self.delay)
                    print(
                        f"{self.dataset_name}, {model_name}, train {task_train + 1}, test {task_test + 1}, "
